...
fn vertexMain(@builtin(vertex_index) vertexID_0 : u32, @builtin(instance_index) instanceID_0 : u32) -> v2f_0
{
    ...
    var vpos_0 : vec3<f32> = data_verts_0[vertexID_0].position_uv_0.xyz;
...
@fragment
fn fragmentMain( _S24 : pixelInput_0, @builtin(position) position_2 : vec4<f32>) -> pixelOutput_0
{
    var _S25 : pixelOutput_0 = pixelOutput_0( vec4<f32>(_S24.color_1, 1.0f) );
    return _S25;
}
