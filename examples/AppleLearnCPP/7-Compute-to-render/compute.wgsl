...
struct _MatrixStorage_float3x3_ColMajorstd430_0
{
    @align(16) data_3 : array<vec3<f32>, i32(3)>,
};
...
struct Instance_std430_0
{
    ...
    @align(16) normalTransform_0 : _MatrixStorage_float3x3_ColMajorstd430_0,
};

@binding(2) @group(0) var<storage, read> data_instances_0 : array<Instance_std430_0>;

@binding(3) @group(0) var data_texture_0 : texture_2d<f32>;
...
{
    var texel_0 : vec3<f32> = (textureSample((data_texture_0), (data_sampler_0), (_S1.tex_coord_2))).xyz;
    var _S2 : pixelOutput_0 = pixelOutput_0( vec4<f32>(vec3<f32>((dot(_S1.color_2, texel_0) * 0.10000000149011612f)) + _S1.color_2 * texel_0 * vec3<f32>(saturate(dot(normalize(_S1.normal_3), normalize(vec3<f32>(1.0f, 1.0f, 0.75f))))), 1.0f) );
    return _S2;
}
