...
fn mandelbrot_set(@builtin(global_invocation_id) index_0 : vec3<u32>)
{
    ...
    var color_0 : f16 = f16(0.5f + 0.5f * cos(3.0f + f32(iteration_0) * 0.15000000596046448f));
    textureStore((data_texture_0), (index_1), (vec4<f32>(vec4<f16>(color_0, color_0, color_0, 1.0h))));
    return;
}
