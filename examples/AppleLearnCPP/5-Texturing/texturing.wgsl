...
{
    var texel_0 : vec3<f32> = (textureSample((data_texture_0), (data_sampler_0), (_S2.tex_coord_2))).xyz;
    var _S3 : pixelOutput_0 = pixelOutput_0( vec4<f32>(vec3<f32>((dot(_S2.color_2, texel_0) * 0.10000000149011612f)) + _S2.color_2 * texel_0 * vec3<f32>(saturate(dot(normalize(_S2.normal_3), normalize(vec3<f32>(1.0f, 1.0f, 0.75f))))), 1.0f) );
    return _S3;
}
