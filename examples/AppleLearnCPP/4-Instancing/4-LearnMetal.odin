...
render :: proc(prev, curr: Window, alpha: f32, arena: ^nuppu.GPU_Arena, pass: nuppu.Frame_Pass) {
    ...
    // Allocate memory for this render frame's instance data
    ...
    for &data, idx in instances_array {
        ...
        // Normally pull these from current simulation states instance data
        // if the actual data lives in cpu side
    }
