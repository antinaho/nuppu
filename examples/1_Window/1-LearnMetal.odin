...
init :: proc() {
    window_app.v_shader = nuppu.shader_init(#load("1-primitive.metal", []u8), "vertexMain", .Vertex)
    window_app.f_shader = nuppu.shader_init(#load("1-primitive.metal", []u8), "fragmentMain", .Fragment)
